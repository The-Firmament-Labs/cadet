        ...
        <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-4 h-[calc(100vh-12rem)]">
          ...
          <div className="overflow-y-auto space-y-2 pr-1">
            {threads.length === 0 ? (
              ...
              threads.map((thread) => (
                <Card key={thread.threadId} className="cursor-default hover:ring-primary/30 transition-shadow">
                  <CardContent className="p-3 space-y-1">
                    ...
                    <div className="flex items-center gap-1 text-[9px] font-mono text-muted-foreground opacity-60">
          ...
          <Card className="flex flex-col">
            ...
            <CardContent className="flex-1 flex items-center justify-center">
              <div className="text-center space-y-2">
                <MessageSquare size={28} className="mx-auto text-muted-foreground opacity-20" />
